...
<!-- Search product -->
	...
	<section class="section-slide">
		<div class="wrap-slick1 rs2-slick1">
			...
			<?php 
				...
				$sql='select * from xpmp_banner_image';
				...
				<div class="item-slick1 bg-overlay1" style="background-image: url(images/<?php echo $row["image"]; ?>); " data-thumb="images/<?php echo $row["image"]; ?>" data-caption="<?php echo $row['title']; ?>">
					<div class="container h-full">
						<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="productWomen.php" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn2 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
	...
	<div class="sec-banner bg0 p-t-95 p-b-55">
		<div class="container">
			<div class="row" >
			<?php
				$sql1='select * from xpmp_category where parent_id="0"';
						...
						{ 
							while($row1=mysqli_fetch_assoc($rs1))
							{
								...
								$sql2='select * from xpmp_category_description where category_id='.$catid;
				...
				<div class="col-md-4 p-b-30 m-lr-auto catalog">
					<!-- Block1 -->
					
					<div class="block1 wrap-pic-w catalog1">
						<img src="images/<?php echo $row2['image']; ?>" alt="IMG-BANNER" width="1000" height="500">

						<a href="product<?php echo $row2['name']; ?>.php" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
...
lively embroidery reflects the charm of its people and warmth of the state
					...
					<div class="blog-item">
						<div class="hov-img0">
							<a href="blog-detail.php">
								<img src="images/Blogs/4.png" alt="IMG-BLOG">
							</a>
						</div>
	...
	<footer class="bg3 p-t-75 p-b-32">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-4 p-b-50">
					...
					<form>
						...
						<div class="p-t-18">
							<button class="flex-c-m stext-101 cl0 size-103 bg1 bor1 hov-btn2 p-lr-15 trans-04" type="submit" name="add1">
								Submit
							</button>
						</div>
					</form>
			...
			<div class="p-t-40">
				...
				<br>
				Designed By <b>Jatin Minocha(JM)<b>

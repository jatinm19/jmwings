	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container" style="margin-top:120px">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					<?php
						...
						$sql1='select category_id from xpmp_category_description where name="Accessories"';
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?php echo $row1['image']; ?>" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<?php
										...
										if($p!=$_SESSION['selected'])
										{ ?>
									<i onclick="myFunction(this)" id= "<?php echo $p; ?>" class="far fa-heart" style="color:red;"></i>
			...
			$rs = mysqli_query($conn,$sql);
				...
				{ 
					...
					{ 
						 $p_id = $row['product_id']; 
							...
							$sql1='select * from xpmp_product where product_id='.$p_id;
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<button class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
									<i onclick="myFunction(this)" id= "<?php echo $selected_p; ?>" class="fas fa-heart"></i>
								</button>
							</div>
							<?php
	}
				...
				<div class="block2-txt-child2 flex-r p-t-3">
								<button class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
									<i onclick="myFunction(this)" id= "<?php echo $p; ?>" class="far fa-heart"></i>
								</button>
							</div>
...
<script type="text/javascript">
  ...
  {
	  var p1= clicked_id;
	  window.location.href="productAccessories.php?uid="+p1;

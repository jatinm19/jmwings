		...
		<div class="container-menu-desktop">
			<div class="wrap-menu-desktop" style="height:auto;background-color:black;">
				<nav class="limiter-menu-desktop p-l-45">
					...
					<!-- Logo desktop -->		
					<a href="index.php" class="logo">jmwings MEN</a>
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					<?php
						...
						$sql1='select category_id from xpmp_category_description where name="Men"';
...
<script type="text/javascript">
  ...
  {
	  var p1= clicked_id;
	  window.location.href="productMen.php?uid="+p1;

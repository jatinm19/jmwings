...
$conn=mysqli_connect('localhost','root','','u381731899_2KPwD');
if (!$conn)
{
	...
	<section class="section-slide">
		<div class="wrap-slick1 rs2-slick1">
			...
			<?php 
				...
				<div class="item-slick1 bg-overlay1" style="background-image: url(images/slide-05.jpg); " data-thumb="images/slide-05.jpg" data-caption="<?php echo $row['title']; ?>">
	...
	<div class="sec-banner bg0 p-t-95 p-b-55">
		<div class="container">
			...
			<?php
				...
				<div class="col-md-6 p-b-30 m-lr-auto catalog">
					<!-- Block1 -->
					
					<div class="block1 wrap-pic-w catalog1">
						<img src="images/banner-04.jpg" alt="IMG-BANNER" width="1000" height="550" >
					...
					<div class="blog-item">
						<div class="hov-img0">
							<a href="blog-detail.php">
								<img src="images/Blogs/1-min.jpg" alt="IMG-BLOG">
							</a>
						</div>

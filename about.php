				...
				<div class="col-md-7 col-lg-8">
					<div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
						...
						<p class="stext-113 cl6 p-b-26">
							Words form the thread on which we string our happy experiences
                                  Define <strong> jmwings</strong>, In which we recreate life strings to weave
                                        Your own path.
						</p>

						<p class="stext-113 cl6 p-b-26">
						
							One of the string is to create a key role of inside story, and bringing
							Social and commercial benefits to the artisan/craftsman can connect 
							Through global audience. <i>Our ideology is to sell the craft not as an
							Object but as a story of the craftsman.</i>

						</p>

						<p class="stext-113 cl6 p-b-26">
							Any questions? Let us know in store at Satha, BSR - 203001 or call us on (+91) 8077484013
						</p>
					</div>
				</div>
			...
			<div class="row">
				<div class="order-md-2 col-md-7 col-lg-8 p-b-30">
					<div class="p-t-7 p-l-85 p-l-15-lg p-l-0-md">
						...
						<p class="stext-113 cl6 p-b-26">
							jmwings has started with an aim of empowering artisans by creating Direct employments and helping to sustain ancient tradition and environment of India.
							Currently, we are giving direct employment to 500 house hold craftsman/ artisans. <br>
							
							<strong>Emerging the fashion through Eco-friendly environment</strong> (using natural colours, eco – friendly colours, and cotton).<br>
							 <strong>We are into zero wastage</strong> (Everything we use, we use fully. Nothing goes into our bins.)<br>
							<strong>We source directly from the craftsman</strong> (Fabrics are sourced from different parts of India and directly from the artist and craftsman). 

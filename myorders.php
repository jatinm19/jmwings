...
<!-- Search product -->
				...
				<h1 style="color:black; text-align:center; margin-bottom:20px;">My Order</h1>
					...
					<div class="m-l-25 m-r-38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<?php
								$a="SELECT * FROM xpmp_myorders where customer_id=2";
								...
								?>
								<tr class="table_row1">
								<td class="column-10"><?php echo $row1['date']; ?></td>
								...
								<td class="column-10"><?php echo $row1['status']; ?></td>

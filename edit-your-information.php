...
session_start();
$conn=mysqli_connect('localhost','root','','happystring');
...
<!-- Search product -->
	...
	<div class="container p-t-50">
		<div class="bread-crumb flex-w p-r-15 p-t-30 p-lr-0-lg">
			...
			<a href="myaccount.php" class="stext-109 cl8 hov-cl1 trans-04">
				My Account
				<i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
			</a>
		</div>
	...
	<div class="container p-t-50 p-b-50">
		<h2 class="ltext-105 txt-center p-b-50">My Account Information</h2>
			<div class="row">
				<div class="col-sm-6 col-lg-6  p-all-33">
		
					<form action="" method="post">
						<h3 class="mtext-105 p-b-20">My Personal Details</h3>

							<hr>
							<?php
						
							$sql="select * from xpmp_customer where customer_id = ".$custid;
							...
							?>
							<label for="fname" style="float:left;"><i class="fas fa-user"></i><b>  First Name<span class="required-field"></span></b></label>
							<input type="text" name="fname" value="<?php echo $row['firstname']; ?>" required>
							
							<label for="lname" style="float:left;"><i class="fas fa-user"></i><b>  Last Name<span class="required-field"></span></b></label>
							<input type="text" name="lname" value="<?php echo $row['lastname']; ?>" required>
							
							<label for="uname" style="float:left;"><i class="fas fa-user"></i><b>  Username<span class="required-field"></span></b></label>
							<input type="text" name="uname" value="<?php echo $row['username']; ?>" required>
							
							 <label for="email" style="float:left;"><i class="fas fa-envelope"></i><b>  Email<span class="required-field"></span></b></label>
							<input type="email" name="email" value="<?php echo $row['email']; ?>" required>
							
							<label for="mobile" style="float:left;"><i class="fas fa-mobile-alt"></i><b>  Mobile<span class="required-field"></span></b></label>
							<input type="tel" name="mobile" pattern="[0-9]{10}" value="<?php echo $row['telephone']; ?>" required>
							
							<label for="dob" style="float:left;"><i class="far fa-calendar-alt"></i><b>  Date Of Birth<span class="required-field"></span></b></label>
							<input type="date" name="dob" value="<?php echo $row['dob']; ?>" required>
							
							<label for="gender" style="float:left;"><i class="fas fa-user"></i><b>  Gender<span class="required-field"></span></b></label><br><br>
							<input type="text" name="gender" value="<?php echo $row['gender']; ?>" required>
							<?php }} ?>
						  
						   <a href="myaccount.php"><button type="submit" class="backbtn" name="back" style="float:left;">Back</button></a>
						    <button type="submit" class="savebtn" name="save" style="float:right;">Save</button>
					</form>
				</div>
			</div>
		</div>
...
$g = $_POST['gender'];
	...
	$in="UPDATE xpmp_customer SET firstname = '$a', lastname ='$b', username = '$c', email = '$d', telephone = '$e', dob = '$f', gender = '$g' where customer_id= '$cusid'";

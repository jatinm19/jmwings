...
{	echo $_SESSION['msg'];
  ...
  <h1 style="color:#fff; font-weight: 500">LOGIN</h1>
   ...
   <div class="col-sm-6 col-lg-6 p-all-53 ">
	...
	<p>If you still don't have a jmwings.co.in account, use this option to access the registration form.</p>

	<p>By giving us your details, purchasing in jmwings.co.in will be faster and an enjoyable experience.</p>
	<br><br>

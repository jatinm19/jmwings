...
<div class="body-content">
   ...
   <div class="container" style="background-color:#191919;color:#a8a8a8;">
	...
	<p>If you have a jmwings.co.in account, use this option to access the Login form.</p>
	<br><br>
		...
		else
		{
			...
			if(mysqli_num_rows($rs)>0)
			{
				while($row=mysqli_fetch_assoc($rs))
				{
					...
					$sql1 = "INSERT INTO xpmp_customer(firstname,lastname,username,email,password,telephone,dob,gender,status) 
					VALUES('$a','$b','$c','$d','$f','$g','$h','$i','unverified')";
					...
					if (mysqli_query($conn, $sql1)) 
					{
						...
						$from         = 'jmwings<info@jmwings.co.in>'; //from mail, sender email addrress 
						$to    = 	$d; //recipient email addrress 	
						$subject     = "Email verification (jmwings.co.in)"; // email subject
						...
						$message .="<div style='padding-top:8px;'>Please click The following link For verifying and activation of your account</div>
												<div style='padding-top:10px;'><a href='http://www.jmwings.co.in/jmwings123/verification.php?code=$activationcode'>Click Here</a></div>
												<div style='padding-top:10px;'>Powered by <a href='jmwings.co.in'>jmwings.co.in</a></div></div>
												</body></html>";

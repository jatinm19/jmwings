...
<!-- Search product -->
	...
	<!-- My Account -->
		...
		<div class="container p-t-50 p-b-50" style="height:500px;">
			 <h2 class="ltext-105 txt-center p-b-50">My Account</h2>
			<div class="row">
				<div class="col-md-6 col-lg-7 p-b-30">
				
			
					  <ul class="list-unstyled mtext-105"> 
						<li><a href="edit-your-information.php">Edit Your Account Information</a></li>

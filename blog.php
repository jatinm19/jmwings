		...
		<div class="container">
				<div>
					<div class="p-r-45 p-r-0-lg">
						<!-- item blog -->
						<div class="p-b-63">
							<a href="blog-detail2.php" class="hov-img0 how-pos5-parent">
...
have always been an innate part of the clothing culture of Rajasthan.
								</p>
								...
								<div class="flex-w flex-sb-m p-t-18">
									...
									<a href="blog-detail.php" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
										...
										<i class="fas fa-long-arrow-alt-right m-l-9"></i>
									</a>
								</div>
							</div>
						</div>
